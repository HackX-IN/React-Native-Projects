...
const SingleSurah = () => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }} className="relative" key={uniqueKey}>
      <View
                      ...
                      >
                        ...
                        >
                          <View className="flex flex-row justify-center">
                            <CustomButton
                              uniqueColor={true}
                              title={`verse-${convertToBanglaNumber(
                                id.toString()
                              )}`}
                            />
                            <AhayDetails
                ...
                >
                  ...
                  >
                    ...
                    <View className="">
                      ...
                      The surah you want to listen to may not be downloaded.
                        To listen to the surah you need to download the complete surah first
                        have to do Do you want to download the surah?
                      </CustomText>
                    </View>
...
Please wait while it downloads.
                      </CustomText>
                    </View>
                  </View>
                </View>
